...
const MyPage = async () => {
  ...
  return (
    <div className="flex w-full flex-col justify-center gap-5 px-4 pb-28 pt-20">
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:gap-11 md:border-b-2 md:border-grey-0 md:pb-5">
