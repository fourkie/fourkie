  ...
  return (
    <main className="mb-5 flex w-full flex-col pb-10 pt-5">
      ...
      <div className="space-y-6 text-sm text-gray-800">
        ...
        <section>
          <h2 className="font-semibold">제6조 개인정보 보호</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold">제7조 제3자 서비스의 이용</h2>
          <ol className="list-inside list-decimal space-y-1">
        ...
        <section>
          <h2 className="font-semibold">제8조 서비스의 중단</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold">제9조 책임의 제한</h2>
          <ol className="list-inside list-decimal space-y-1">
            <li>
        ...
        <section>
          <h2 className="font-semibold">제10조 지적재산권</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold">제11조 관할법원 및 준거법</h2>
          <p>
